...
public class Thunder5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (ds < 5 && myTransform.position == playerTransform.position && ThunderTime > 1 && finish == 0 && gameManager.fall == 1)
        {
            gameManager.hide = 1;
            audio.Stop();
            finish = 1;
