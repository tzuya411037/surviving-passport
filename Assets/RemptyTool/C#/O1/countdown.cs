...
public class countdown : MonoBehaviour
{
    ...
    public UnityEngine.UI.Text m_timer;           //設定畫面倒數計時的文字
    ...
    void Update()
    {
        ...
        if (gameManager.bb == 1 && gameManager.call == 2)
        {
            gameManager.call = 3;
    ...
    IEnumerator Countdown()
    {
        ...
        if (gameManager.numb > 99 && gameManager.numb < 121)
        {
            SceneManager.LoadScene(goToTheScene);
        }
        else { gameManager.chance = 35; }
