...
public class Text0n2 : MonoBehaviour
{
    ...
    void Update()
    {
        if (gameManager4.clear > 0) { Text01.SetActive(true); }
        else { Text01.SetActive(false); }
        if(gameManager5==null) { Text02.SetActive(false); }
        else if (gameManager5.clear > 0) { Text02.SetActive(true); }
